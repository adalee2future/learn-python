# simple music player, users buttons and sounds
# note that .off sounds are not supported in Safari
...
# initialize volume, create button whose label will display
vol = 7
volume_button = frame.add_label("Velume = " + str(vol))
...
# make the laugh quieter so my eats don't bleed
laugh.set_volume(.1)

"""
Conducting multiple trails using random.randrange()
"""
...
def roll_die(num_sides):
    """
    Simulate a trial conrresponding to the roll of die
    with specified number is sides
    """
...
def roll_test(num_sides, num_rolls): 
    ...
    for _ in range(num_rolls):
        ...
        print "Roll was", roll 
        #print "Roll was even is", roll in EVEN-eVENT
...
# Test whether random.range simulates a fair die

...
Animation
    ...
    Create the illusion that continuous motion is being seen rather than a series of
    discontinuous images being exchanged in succession (e.g; 24 frames per sec in movies)
    
    Example - horizontally tiled image consisting of 64 images of tumbling asteroid
    
    Animate tumbling asteroid - draw each sub-image briefly in sequence 
'''
